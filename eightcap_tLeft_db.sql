...
COPY public.consumer (id, first_name, last_name, address, phone_number, dba_id, hmis, internet_access, pre_screen_timestamp, county_id, pref_contact_method_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.communication_status_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.pref_contact_method_id_seq', 1, false);
...
--
-- Name: communication communication_communication_status_id_key; Type: CONSTRAINT; Schema: public; Owner: jninn
--

ALTER TABLE ONLY public.communication
    ADD CONSTRAINT communication_communication_status_id_key UNIQUE (communication_status_id);


--
-- Name: communication communication_consumer_id_key; Type: CONSTRAINT; Schema: public; Owner: jninn
--

ALTER TABLE ONLY public.communication
    ADD CONSTRAINT communication_consumer_id_key UNIQUE (consumer_id);
...
--
-- Name: communication communication_staff_id_key; Type: CONSTRAINT; Schema: public; Owner: jninn
--

ALTER TABLE ONLY public.communication
    ADD CONSTRAINT communication_staff_id_key UNIQUE (staff_id);
...
--
-- Name: consumer consumer_county_id_key; Type: CONSTRAINT; Schema: public; Owner: jninn
--

ALTER TABLE ONLY public.consumer
    ADD CONSTRAINT consumer_county_id_key UNIQUE (county_id);
...
--
-- Name: consumer consumer_pref_contact_method_id_key; Type: CONSTRAINT; Schema: public; Owner: jninn
--

ALTER TABLE ONLY public.consumer
    ADD CONSTRAINT consumer_pref_contact_method_id_key UNIQUE (pref_contact_method_id);
...
--
-- Name: staff staff_department_id_key; Type: CONSTRAINT; Schema: public; Owner: jninn
--

ALTER TABLE ONLY public.staff
    ADD CONSTRAINT staff_department_id_key UNIQUE (department_id);
